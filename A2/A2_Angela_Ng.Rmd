...
```{r, fig.cap="Figure X: Manhattan Plot of ORA results for all differentially expressed genes"}
gprofiler2::gostplot(gostAll)
```

```{r, fig.cap="Figure X: Manhattan Plot of ORA results for up-regulated genes"}
gprofiler2::gostplot(gostUp)
```

```{r, fig.cap="Figure X: Manhattan Plot of ORA results for down-regulated genes"}
...
https://bmccardiovascdisord.biomedcentral.com/articles/10.1186/s12872-020-01596-w
https://www.nature.com/articles/s41598-022-26277-w#Sec12
