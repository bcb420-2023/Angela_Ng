...
![Figure 10: Network zoomed in on location of atenolol, digoxin, mexiletine, and nebivolol.](figures/other_drugs_in_network.png)
Figure 11 below is zoomed in on the group of pathways these drugs interact the most with.

![Figure 11: Pathways associated with heart contraction](figures/heart_contractions.png)

These interactions make sense since those with DCM, ICM, and heart failure have trouble with heart contractions resulting in issues with blood flow and these drugs attempt to make it easier for the heart to circulate blood through the body.  For example, atenolol is used to lower blood pressure [@DCMDrugs].
