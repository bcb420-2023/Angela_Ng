...
The difference between the number of ensembl IDs mapped and the number of genes in the data set are identical.  This means all of the genes were successfully matched.
